<template>
  <div class="goodsdetail" ref="goodsdetail">
      ...
      <div class="goods_price">
        ...
        <div class="goods_price_right">
          <span class="goods_price_right_left">
            <img
              src="data:image/png;base64,"
            />
            降价提醒
          </span>
    ...
    <div class="question_answer">
      ...
      <div class="question_answer2">
        <div class="question_answer2_1">
          <span class="question_answer2_2">Q</span>您好，刚才我要的衣柜，尺寸搞错
        </div>
      ...
      <div class="question_answer2">
        <div class="question_answer2_1">
          <span class="question_answer2_2">Q</span>你好，这个衣柜有1.3m 吗？
        </div>
        <div class="question_answer2_3">暂无回答</div>
      </div>
    </div>
            ...
            <div class="swiper-slide">
              <div class="swiper-slide_container">
                <div class="item11" v-for="item in list1" :key="item.id">
                  <div class="guess_silde_1">
                    <img :src="item.img" />
                  </div>
                  <div class="guess_silde_2">{{item.desc}}</div>
    ...
    <div class="addshoppongcarjump" ref="addshoppongcarjump1">
      ...
      <div class="addshoppongcarjump_4">保障服务</div>

      <div class="addshoppongcarjump_5">
        <div class="addshoppongcarjump_5_left">
          <i class="el-icon-s-claim"></i>服务保障
        </div>
        <div class="addshoppongcarjump_5_right">
          服务介绍
          <i class="el-icon-arrow-right"></i>
        </div>
      </div>
...
.indexlz1 .swiper-wrapper {
  width: 100%;
  height: 100%;
}

.indexlz1 .swiper-wrapper .swiper-slide {
  width: 100%;
  height: 400px;
}

.indexlz1 .swiper-wrapper .swiper-slide .swiper-slide_container {
  display: flex;
  flex-wrap: wrap;
  width: 100%;
  height: 100%;
...
.indexlz1 .swiper-wrapper .swiper-slide .swiper-slide_container .item11 {
  width: 33.3%;
  height: 50%;
